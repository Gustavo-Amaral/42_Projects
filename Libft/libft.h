...
/*   Updated: 2023/06/15 21:04:45 by gamaral          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief  Splits a string into smaller strings that are separated by character c
 * @note
...
/**
 * @brief  Searches for the occurrency of character c in the string s
 * @note
