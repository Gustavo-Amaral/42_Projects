...
/*   Updated: 2023/11/11 19:36:53 by gamaral          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @note   Memory is allocated for the the returned double pointer.
 ...
 * @note
 * @param  list_head: Pointer to the first list element
 * @retval None
 */
void	ft_lstprintall(t_list *list_head);

/**
 * @brief  Prints the list element value (int type)
 * @note
 * @param  lst_elem: Pointer to the list element
 * @retval None
 */
